...
class EventSksHodoscopeSigma : public VEvent
{
...
EventSksHodoscopeSigma::EventSksHodoscopeSigma()
  : VEvent(), 
    rawData(0), 
...
bool EventSksHodoscopeSigma::ProcessingBegin()
...
bool EventSksHodoscopeSigma::ProcessingNormal()
{
  static const std::string funcname = "[EventSksHodoscopeSigma::ProcessingNormal]";
...
void EventSksHodoscopeSigma::InitializeEvent( void )
{
...
bool EventSksHodoscopeSigma::ProcessingEnd()
{
  // gFile->Write();
  // gFile->Close();
...
{
  return new EventSksHodoscopeSigma;
}
