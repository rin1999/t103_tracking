...
#ifndef s_BeamRawHit_h 
#define s_BeamRawHit_h 1
...
private:
  ...
  s_HodoRHitContainer sT0RHC;

  s_TrRHitContainer sbSSDRHC[PlMaxbSSD+1];
...
public:
  s_BeamRawHit( int trackid, int tracktype )
...
public:
  ...
  //Beam information
  const s_HodoRHitContainer& GetsT0RHC() const;

  const s_TrRHitContainer& GetsbSSDRHC( int layer ) const;
