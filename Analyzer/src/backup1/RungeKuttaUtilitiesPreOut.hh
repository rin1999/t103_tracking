/*
  RungeKuttaUtilitiesPreOut.hh

  2004/6/28    T.Takahashi

*/

#ifndef RungeKuttaUtilitiesPreOut_h

#define RungeKuttaUtilitiesPreOut_h 1
...
class RKPreOutFieldIntegral;
class RKPreOutDeltaFieldIntegral;
class RKPreOutTrajectoryPoint;
class RKPreOutcalcHitPoint;
class RKPreOutCordParameter;
class RKPreOutHitPointContainer;

class RKPreOutFieldIntegral
{
public:
  RKPreOutFieldIntegral( double Ky, double Kz, 
...
public:
  ...
  friend RKPreOutTrajectoryPoint RKPreOuttraceOneStep( double, const RKPreOutTrajectoryPoint & );
  friend RKPreOutDeltaFieldIntegral
  RKPreOutcalcDeltaFieldIntegral( const RKPreOutTrajectoryPoint &, 
				  const RKPreOutFieldIntegral &,
				  const RKPreOutDeltaFieldIntegral &, 
				  const RKPreOutDeltaFieldIntegral &, double );
  friend RKPreOutDeltaFieldIntegral
  RKPreOutcalcDeltaFieldIntegral( const RKPreOutTrajectoryPoint &,
				  const RKPreOutFieldIntegral & );
};
...
{
public:
  RKPreOutDeltaFieldIntegral( double dKyy, double dKyz, double dKyu,
...
{
public:
  RKPreOutCordParameter( ) {}
  RKPreOutCordParameter( double X, double Y, double Z,
			double U, double V, double Q )
    : x(X), y(Y), z(Z), u(U), v(V), q(Q)
  {}
  
  RKPreOutCordParameter( const ThreeVector &pos,
			 double U, double V, double Q )
...
public:
  ...
  friend class RKPreOutTrajectoryPoint;
  friend RKPreOutTrajectoryPoint 
  RKPreOuttraceOneStep( double, const RKPreOutTrajectoryPoint & );
  friend RKPreOutDeltaFieldIntegral
  RKPreOutcalcDeltaFieldIntegral( const RKPreOutTrajectoryPoint &, 
				  const RKPreOutFieldIntegral &,
				  const RKPreOutDeltaFieldIntegral &, 
  ...
  RKPreOutcalcDeltaFieldIntegral( const RKPreOutTrajectoryPoint &,
				  const RKPreOutFieldIntegral & );
  friend bool 
  RKPreOutcheckCrossing( int, const RKPreOutTrajectoryPoint &, 
			 const RKPreOutTrajectoryPoint &, RKPreOutcalcHitPoint & );
};
...
{
public:
  RKPreOutTrajectoryPoint( double X, double Y, double Z,
			   double U, double V, double Q,
  ...
  RKPreOutTrajectoryPoint( const RKPreOutCordParameter &R,
			   double Dydy, double Dydz, double Dydu, 
			   double Dydv, double Dydq,
			   double Dzdy, double Dzdz, double Dzdu, 
			   double Dzdv, double Dzdq,
  ...
  RKPreOutTrajectoryPoint( const ThreeVector &pos,
			   double U, double V, double Q,
			   double Dydy, double Dydz, double Dydu, 
			   double Dydv, double Dydq,
			   double Dzdy, double Dzdz, double Dzdu, 
...
class RKPreOutcalcHitPoint {
public:
  RKPreOutcalcHitPoint() {}
  RKPreOutcalcHitPoint( const ThreeVector &pos, const ThreeVector &mom,
			double S, double L, 
...
class RKPreOutHitPointContainer  
  : public std::vector<std::pair<int,RKPreOutcalcHitPoint> >
{
public:
  const RKPreOutcalcHitPoint & HitPointOfLayer( int lnum ) const;
  RKPreOutcalcHitPoint & HitPointOfLayer( int lnum );
  
  typedef std::vector<std::pair<int,RKPreOutcalcHitPoint> >
  ::const_iterator RKPreOutHpCIterator;
  
  typedef std::vector<std::pair<int,RKPreOutcalcHitPoint> >
  ::iterator RKPreOutHpIterator;
  
};

/////////////////////////////////////////////////////////////////////////
inline std::ostream & operator << ( std::ostream &ost, 
                                    const RKPreOutFieldIntegral &obj )
{ obj.Print( ost ); return ost; }

inline std::ostream & operator << ( std::ostream &ost, 
                                    const RKPreOutDeltaFieldIntegral &obj )
{ obj.Print( ost ); return ost; }

inline std::ostream & operator << ( std::ostream &ost, 
                                    const RKPreOutCordParameter &obj ) 
{ obj.Print( ost ); return ost; }
inline std::ostream & operator << ( std::ostream &ost, 
                                    const RKPreOutTrajectoryPoint &obj ) 
{ obj.Print( ost ); return ost; }
//////////////////////////////////////////////////////////////////////////
...
RKPreOuttraceOneStep( double StepSize, const RKPreOutTrajectoryPoint &prevPoint );
