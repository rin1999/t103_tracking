...
public:
  ...
  void SetTdcVal( double tdc );
  void SetTdcTrailing(double tdc) {trailing_.push_back(tdc); }
  ...
  double GetTdcVal( int nh=0 ) const { return tdc_[nh]; }
  double GetTdcTrailing( int nh=0 ) const { return trailing_[nh]; }
