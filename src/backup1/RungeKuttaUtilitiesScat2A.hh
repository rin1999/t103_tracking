/*
  RungeKuttaUtilitiesScat2A.hh

  2004/6/28    T.Takahashi

*/

#ifndef RungeKuttaUtilitiesScat2A_h

#define RungeKuttaUtilitiesScat2A_h 1
...
class RKScat2AFieldIntegral;
class RKScat2ADeltaFieldIntegral;
class RKScat2ATrajectoryPoint;
class RKScat2AcalcHitPoint;
class RKScat2ACordParameter;
class RKScat2AHitPointContainer;

class RKScat2AFieldIntegral
{
public:
  RKScat2AFieldIntegral( double Ky, double Kz, 
...
public:
  ...
  friend RKScat2ATrajectoryPoint RKScat2AtraceOneStep( double, const RKScat2ATrajectoryPoint & );
  friend RKScat2ADeltaFieldIntegral
  RKScat2AcalcDeltaFieldIntegral( const RKScat2ATrajectoryPoint &, 
				  const RKScat2AFieldIntegral &,
				  const RKScat2ADeltaFieldIntegral &, 
				  const RKScat2ADeltaFieldIntegral &, double );
  friend RKScat2ADeltaFieldIntegral
  RKScat2AcalcDeltaFieldIntegral( const RKScat2ATrajectoryPoint &,
				  const RKScat2AFieldIntegral & );
};
...
{
public:
  RKScat2ADeltaFieldIntegral( double dKyy, double dKyz, double dKyu,
...
{
public:
  RKScat2ACordParameter( ) {}
  RKScat2ACordParameter( double X, double Y, double Z,
			 double U, double V, double Q )
    : x(X), y(Y), z(Z), u(U), v(V), q(Q)
  {}
  
  RKScat2ACordParameter( const ThreeVector &pos,
			 double U, double V, double Q )
...
public:
  ...
  friend class RKScat2ATrajectoryPoint;
  friend RKScat2ATrajectoryPoint 
  RKScat2AtraceOneStep( double, const RKScat2ATrajectoryPoint & );
  friend RKScat2ADeltaFieldIntegral
  RKScat2AcalcDeltaFieldIntegral( const RKScat2ATrajectoryPoint &, 
				  const RKScat2AFieldIntegral &,
				  const RKScat2ADeltaFieldIntegral &, 
  ...
  RKScat2AcalcDeltaFieldIntegral( const RKScat2ATrajectoryPoint &,
				  const RKScat2AFieldIntegral & );
  friend bool 
  RKScat2AcheckCrossing( int, const RKScat2ATrajectoryPoint &, 
			 const RKScat2ATrajectoryPoint &, RKScat2AcalcHitPoint & );
};
...
{
public:
  RKScat2ATrajectoryPoint( double X, double Y, double Z,
			   double U, double V, double Q,
  ...
  RKScat2ATrajectoryPoint( const RKScat2ACordParameter &R,
			   double Dydy, double Dydz, double Dydu, 
			   double Dydv, double Dydq,
			   double Dzdy, double Dzdz, double Dzdu, 
			   double Dzdv, double Dzdq,
  ...
  RKScat2ATrajectoryPoint( const ThreeVector &pos,
			   double U, double V, double Q,
			   double Dydy, double Dydz, double Dydu, 
			   double Dydv, double Dydq,
			   double Dzdy, double Dzdz, double Dzdu, 
...
class RKScat2AcalcHitPoint {
public:
  RKScat2AcalcHitPoint() {}
  RKScat2AcalcHitPoint( const ThreeVector &pos, const ThreeVector &mom,
			double S, double L, 
...
class RKScat2AHitPointContainer  
  : public std::vector<std::pair<int,RKScat2AcalcHitPoint> >
{
public:
  const RKScat2AcalcHitPoint & HitPointOfLayer( int lnum ) const;
  RKScat2AcalcHitPoint & HitPointOfLayer( int lnum );
  
  typedef std::vector<std::pair<int,RKScat2AcalcHitPoint> >
  ::const_iterator RKScat2AHpCIterator;
  
  typedef std::vector<std::pair<int,RKScat2AcalcHitPoint> >
  ::iterator RKScat2AHpIterator;
  
};

/////////////////////////////////////////////////////////////////////////
inline std::ostream & operator << ( std::ostream &ost, 
                                    const RKScat2AFieldIntegral &obj )
{ obj.Print( ost ); return ost; }

inline std::ostream & operator << ( std::ostream &ost, 
                                    const RKScat2ADeltaFieldIntegral &obj )
{ obj.Print( ost ); return ost; }

inline std::ostream & operator << ( std::ostream &ost, 
                                    const RKScat2ACordParameter &obj ) 
{ obj.Print( ost ); return ost; }
inline std::ostream & operator << ( std::ostream &ost, 
                                    const RKScat2ATrajectoryPoint &obj ) 
{ obj.Print( ost ); return ost; }
//////////////////////////////////////////////////////////////////////////
...
RKScat2AtraceOneStep( double StepSize, const RKScat2ATrajectoryPoint &prevPoint );
