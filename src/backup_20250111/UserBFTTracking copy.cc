...
struct Event{
   ...
   std::vector<std::vector<double>> ltdc_corrected_bft_l1, ltdc_corrected_bft_l2, ltdc_corrected_bft_l3, ltdc_corrected_bft_l4, ltdc_corrected_bft_l5, ltdc_corrected_bft_l6;
...
bool EventBFTTracking::ProcessingNormal( TFile* iFile, int evnum )
{
   ...
   for(int i_entry = 0; i_entry < n_entry; i_entry++){
     ...
     //BFT Rawdata
       ...
       event.ltdc_corrected_bft_l1.resize(NumOfFiberBFT);
       event.ltdc_corrected_bft_l2.resize(NumOfFiberBFT);
       event.ltdc_corrected_bft_l3.resize(NumOfFiberBFT);
       event.ltdc_corrected_bft_l4.resize(NumOfFiberBFT);
       event.ltdc_corrected_bft_l5.resize(NumOfFiberBFT);
       event.ltdc_corrected_bft_l6.resize(NumOfFiberBFT);
             ...
             for( int i=0; i<nh; ++i ){
               ...
               if(layerId==1){
                  ...
                  for( int it=0; it<hit->GetSize_lTdc(); ++it ){
                     ...
                     double ltdc_corrected = ltdc;// - (p0[layerId-1]+p1[layerId-1]*tot+p2[layerId-1]*tot*tot);
                     event.ltdc_bft_l1[fiberId-1].push_back(ltdc);
                     event.ltdc_corrected_bft_l1[fiberId-1].push_back(ltdc_corrected);
                   }
                ...
                if(layerId==2){
                   ...
                   for( int it=0; it<hit->GetSize_lTdc(); ++it ){
                     ...
                     event.ltdc_corrected_bft_l2[fiberId-1].push_back(ltdc_corrected);
                   }
                   for( int it=0; it<hit->GetSize_Tot(); ++it )
                ...
                if(layerId==3){
                   ...
                   for( int it=0; it<hit->GetSize_lTdc(); ++it ){
                     ...
                     event.ltdc_corrected_bft_l3[fiberId-1].push_back(ltdc_corrected);
                   }
                   for( int it=0; it<hit->GetSize_Tot(); ++it )
                ...
                if(layerId==4){
                   ...
                   for( int it=0; it<hit->GetSize_lTdc(); ++it ){
                     ...
                     event.ltdc_corrected_bft_l4[fiberId-1].push_back(ltdc_corrected);
                   }
                   for( int it=0; it<hit->GetSize_Tot(); ++it )
                ...
                if(layerId==5){
                   ...
                   for( int it=0; it<hit->GetSize_lTdc(); ++it ){
                     ...
                     event.ltdc_corrected_bft_l5[fiberId-1].push_back(ltdc_corrected);
                   }
                   for( int it=0; it<hit->GetSize_Tot(); ++it )
                ...
                if(layerId==6){
                   ...
                   for( int it=0; it<hit->GetSize_lTdc(); ++it ){
                     ...
                     event.ltdc_corrected_bft_l6[fiberId-1].push_back(ltdc_corrected);
                   }
                   for( int it=0; it<hit->GetSize_Tot(); ++it )
          ...
          for( int layer=1; layer<=NumOfLayersBFT; ++layer ){
             ...
             for( int i=0; i<nh; ++i ){
                ...
                for( int k=0; k<nhtdc; k++ ){
                   ...
                   double tdc_corrected = tdc - (p0[layer-1]+p1[layer-1]*tot+p2[layer-1]*tot*tot);
...
void EventBFTTracking::InitializeEvent( void )
{
   ...
   for(int i=0; i<event.ltdc_corrected_bft_l1.size(); i++) event.ltdc_corrected_bft_l1[i].clear();
   for(int i=0; i<event.ltdc_corrected_bft_l2.size(); i++) event.ltdc_corrected_bft_l2[i].clear();
   for(int i=0; i<event.ltdc_corrected_bft_l3.size(); i++) event.ltdc_corrected_bft_l3[i].clear();
   for(int i=0; i<event.ltdc_corrected_bft_l4.size(); i++) event.ltdc_corrected_bft_l4[i].clear();
   for(int i=0; i<event.ltdc_corrected_bft_l5.size(); i++) event.ltdc_corrected_bft_l5[i].clear();
   for(int i=0; i<event.ltdc_corrected_bft_l6.size(); i++) event.ltdc_corrected_bft_l6[i].clear();
