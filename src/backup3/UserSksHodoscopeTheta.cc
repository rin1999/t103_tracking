...
const double MaxDeltaETof = 1.60; //for Kaon
const double MinTimeTof =  19.5;
const double MaxTimeTof =  29.5;

// LC Cut Parameters
const double MinDeltaELc = 0.05; //for Kaon
const double MaxDeltaELc = 3.5; //for Kaon
const double MinTimeLc =  23.0;
const double MaxTimeLc =  39.5;

// TOF-LC  
const double MinToFT2L =   1.0;
const double MaxToFT2L =  13.0;
const int MinToF2LSeg  =  -1;
const int MaxToF2LSeg  =  14;
...
//SdcIn vs TOF&LC cut
const double MinModTimeTof = 21.5;
const double MaxModTimeTof = 26.0;
const double MinModTimeLc  = 25.5;
const double MaxModTimeLc  = 32.5;
// const double MinModTimeTof = 22.5;
// const double MaxModTimeTof = 25.0;
// const double MinModTimeLc  = 26.5;
// const double MaxModTimeLc  = 31.5;
...
// LC-SdcOut
const double MinXDifLc  = -500.;
const double MaxXDifLc  =  500.;
...
class EventSksHodoscopeTheta : public VEvent
{
...
EventSksHodoscopeTheta::EventSksHodoscopeTheta()
  : VEvent(), 
    rawData(0), 
...
bool EventSksHodoscopeTheta::ProcessingBegin()
...
bool EventSksHodoscopeTheta::ProcessingNormal()
{
  static const std::string funcname = "[EventSksHodoscopeTheta::ProcessingNormal]";
...
void EventSksHodoscopeTheta::InitializeEvent( void )
{
...
bool EventSksHodoscopeTheta::ProcessingEnd()
{
  // gFile->Write();
  // gFile->Close();
...
{
  return new EventSksHodoscopeTheta;
}
