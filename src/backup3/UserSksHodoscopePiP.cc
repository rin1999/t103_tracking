...
const double MaxDeltaETof = 6.0; //for Kaon
const double MinTimeTof =   0.0;
const double MaxTimeTof =  50.0;

const double MinDeltaELc = 0.00; //for Kaon
const double MaxDeltaELc = 6.00; //for Kaon
const double MinTimeLc =  00.0;
const double MaxTimeLc =  60.0;

const double MinToFT2L = -30.0;
const double MaxToFT2L =  30.0;
const int MinToF2LSeg  = -30;
const int MaxToF2LSeg  =  30;

const double MinModTimeTof = 19.0;
const double MaxModTimeTof = 26.5;
const double MinModTimeLc  = 24.0;
const double MaxModTimeLc  = 32.0;

///////////////////////////////Tight
// const double MinDeltaETof = 1.00; //for Proton
// const double MaxDeltaETof = 6.00; //for Proton
// const double MinTimeTof =  20.0;
// const double MaxTimeTof =  36.0;

// const double MinDeltaELc = 0.00; //for Proton
// const double MaxDeltaELc = 1.40; //for Proton
// const double MinTimeLc =  30.0;
// const double MaxTimeLc =  50.0;

// const double MinToFT2L = -30.0;
// const double MaxToFT2L =  30.0;
// const int MinToF2LSeg  = -20;
// const int MaxToF2LSeg  =  20;

// const double MinModTimeTof =  26.0;
// const double MaxModTimeTof =  29.0;
// const double MinModTimeLc  =   0.0;
// const double MaxModTimeLc  = 100.0;
...
// LC-SdcOut
const double MinXDifLc  = -100.;
const double MaxXDifLc  =  100.;
...
class EventSksHodoscopePiP : public VEvent
{
...
EventSksHodoscopePiP::EventSksHodoscopePiP()
  : VEvent(), 
    rawData(0), 
...
bool EventSksHodoscopePiP::ProcessingBegin()
...
bool EventSksHodoscopePiP::ProcessingNormal()
{
  static const std::string funcname = "[EventSksHodoscopePiP::ProcessingNormal]";
  ...
  event.nhTof=ncTof;
  {
	...
	x=(ms-16.5)*70., y=dt*50.;
      ...
      //------------------------Cut
      if( MinTimeTof  <t  && t<MaxTimeTof && (cl->MeanSeg()+1)>9 ){
        ++ncOk;
...
void EventSksHodoscopePiP::InitializeEvent( void )
{
...
bool EventSksHodoscopePiP::ProcessingEnd()
{
  // gFile->Write();
  // gFile->Close();
...
{
  return new EventSksHodoscopePiP;
}
