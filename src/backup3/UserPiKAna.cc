...
const double MinDeltaEBH2 = 0.3; //for Pion
const double MaxDeltaEBH2 = 4.0; //for Pion

const double MinDeltaEBH1 = 0.3; //for Pion
const double MaxDeltaEBH1 = 4.0; //for Pion

const double MinBeamToF  = -4.0;
const double MaxBeamToF  =  4.0;

const double MinDeltaETof = 0.3; //for Kaon
const double MaxDeltaETof = 3.2; //for Kaon

const double MinTimeTof = -4.0;
const double MaxTimeTof = 40.0;

const double MinDeltaELc = 0.00; //for Kaon
const double MaxDeltaELc = 4.0; //for Kaon
...
const int MinToF2LSeg =  -3;
const int MaxToF2LSeg =  13;
...
const double MinMassSquare =  0.00;
const double MaxMassSquare =  0.50;
// const double MinMassSquare = -0.3;
// const double MaxMassSquare =  1.1;
...
bool EventPiKAna::ProcessingBegin()
...
bool EventPiKAna::ProcessingNormal()
{
  rawData = new RawData;
  rawData->DecodeHits();
...
void EventPiKAna::InitializeEvent( void )
{
...
bool EventPiKAna::ProcessingEnd()
{
  // gFile->Write();
  // gFile->Close();
  return true;
