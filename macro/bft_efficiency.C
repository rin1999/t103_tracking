...
void bft_efficiency(const char* filepath, const int process_entries){
    ...
    vector<vector<double>>* ltdc_bref_l=0;
    vector<vector<double>>* ltdc_bref_r=0;
    vector<vector<double>>* tot_bref_l=0;
    vector<vector<double>>* tot_bref_r=0;
    ...
    for (int i_entry=0; i_entry<N_entry; i_entry++){
        ...
        fill_vecvecDouble_toTH1F(h_ltdc_bref_l, ltdc_bref_l);
        fill_vecvecDouble_toTH1F(h_ltdc_bref_r, ltdc_bref_r);
        fill_vecvecDouble_toTH1F(h_tot_bref_l, tot_bref_l);
        fill_vecvecDouble_toTH1F(h_tot_bref_r, tot_bref_r);
