...
void print_branches(const char* filepath, const int process_entries){
    ...
    TH2F* h_multi = new TH2F("h_multi", "Multiplicity", 6, 0, 6, 10, 0, 10);
    TH1F* h_pos[6];
    TH1F* h_res[6];
    TH1F* h_res_xy_cut[6];
    TH1F* h_ltdc_bft[6];
    ...
    for(int i=0; i<6; i++){
        ...
        h_res[i] = new TH1F(Form("h_res%d", i+1), Form("residual of layer %d", i+1), 200, -2., 2.);
    ...
    for (int i_entry=0; i_entry<N_entry; i_entry++){
        ...
        for (int i_layer=0; i_layer<6; i_layer++){
            int multiplicity_count_layer=0;
            for (int i_fiber=0; i_fiber<256; i_fiber++){
                ...
                for (int i_hit=0; i_hit<ltdc_bft[i_layer]->at(i_fiber).size(); i_hit++){
                    if (ltdc_min<ltdc_bft[i_layer]->at(i_fiber).at(i_hit) && ltdc_bft[i_layer]->at(i_fiber).at(i_hit)<ltdc_max){
                        multiplicity_count++;
                        multiplicity_count_layer++;
                    } 
                }
                h_multi_bft[i_layer] -> Fill(i_fiber, multiplicity_count);
            }
            h_multi -> Fill(i_layer, multiplicity_count_layer);
        }
        ...
        for (int i_layer=0; i_layer<6; i_layer++){
            for (int i=0; i<x0->size(); i++){
                if (-50.5<x0->at(i) && x0->at(i)<50.5 && -50.5<y0->at(i) && y0->at(i)<50.5){
                    ...
                    fill_vecvecDouble_toTH1F(h_res_xy_cut[i_layer], res[i_layer]);
                    //h_res_xy_cut[i_layer] -> Fill(res[i_layer]->at());
                    //cout << res[i_layer]->size() << endl;
                    for (int i_fiber=0; i_fiber<256; i_fiber++){
                        if (res[i_layer]->at(i_fiber)){
                            for (int i=0; i<res[i_layer]->at(i_fiber).size(); i++){
                                cout << "i_layer=" << i_layer << "  i_fiber=" << i_fiber << "  :" << res[i_layer]->at(i_fiber).at(i) << endl;
                            }
                        }
                    }
                }
    ...
    */
    ...
    h_x0y0 -> GetYaxis() -> SetTitleOffset(1.4);
    h_x0y0 -> SetStats(0);
    h_x0y0 -> Draw("COLZ");
    ...
    h_u0v0 -> SetXTitle("dx/dz [rad]");
    h_u0v0 -> SetYTitle("dy/dz [rad]");
    h_u0v0 -> GetXaxis() -> SetTitleOffset(1.3);
    h_u0v0 -> GetYaxis() -> SetTitleOffset(1.4);
    h_u0v0 -> SetStats(0);
    h_u0v0 -> Draw("COLZ");
    ...
    h_x0y0_csize0 -> GetYaxis() -> SetTitleOffset(1.4);
    h_x0y0_csize0 -> SetStats(0);
    h_x0y0_csize0 -> Draw("COLZ");
    c -> Print(savepath.c_str());
    c -> Clear();
    ...
    h_u0v0_csize0 -> GetYaxis() -> SetTitleOffset(1.4);
    h_u0v0_csize0 -> SetStats(0);
    h_u0v0_csize0 -> Draw("COLZ");
    c -> Print(savepath.c_str());
    c -> Clear();
    ...
    h_x0y0_csize1 -> GetYaxis() -> SetTitleOffset(1.4);
    h_x0y0_csize1 -> SetStats(0);
    h_x0y0_csize1 -> Draw("COLZ");
    c -> Print(savepath.c_str());
    c -> Clear();
    ...
    h_u0v0_csize1 -> GetYaxis() -> SetTitleOffset(1.4);
    h_u0v0_csize1 -> SetStats(0);
    h_u0v0_csize1 -> Draw("COLZ");
    c -> Print(savepath.c_str());
    c -> Clear();
    ...
    h_x0y0_csize2 -> GetYaxis() -> SetTitleOffset(1.4);
    h_x0y0_csize2 -> SetStats(0);
    h_x0y0_csize2 -> Draw("COLZ");
    c -> Print(savepath.c_str());
    c -> Clear();
    ...
    h_u0v0_csize2 -> GetYaxis() -> SetTitleOffset(1.4);
    h_u0v0_csize2 -> SetStats(0);
    h_u0v0_csize2 -> Draw("COLZ");
    c -> Print(savepath.c_str());
    c -> Clear();
    ...
    h_x0y0_csize3 -> GetYaxis() -> SetTitleOffset(1.4);
    h_x0y0_csize3 -> SetStats(0);
    h_x0y0_csize3 -> Draw("COLZ");
    c -> Print(savepath.c_str());
    c -> Clear();
    ...
    h_u0v0_csize3 -> GetYaxis() -> SetTitleOffset(1.4);
    h_u0v0_csize3 -> SetStats(0);
    h_u0v0_csize3 -> Draw("COLZ");
    c -> Print(savepath.c_str());
    c -> Clear();
    ...
    h_x0y0_csize4ormore -> GetYaxis() -> SetTitleOffset(1.4);
    h_x0y0_csize4ormore -> SetStats(0);
    h_x0y0_csize4ormore -> Draw("COLZ");
    c -> Print(savepath.c_str());
    c -> Clear();
    ...
    h_u0v0_csize4ormore -> GetYaxis() -> SetTitleOffset(1.4);
    h_u0v0_csize4ormore -> SetStats(0);
    h_u0v0_csize4ormore -> Draw("COLZ");
    c -> Print(savepath.c_str());
    c -> Clear();
    ...
    h_x1y1 -> GetYaxis() -> SetTitleOffset(1.4);
    h_x1y1 -> SetStats(0);
    h_x1y1 -> Draw();
    c -> Print(savepath.c_str());
    c -> Clear();
    ...
    h_u1v1 -> GetYaxis() -> SetTitleOffset(1.4);
    h_u1v1 -> SetStats(0);
    h_u1v1 -> Draw();
    c -> Print(savepath.c_str());
    c -> Clear();
    ...
    */
    ...
    for (int i=0; i<6; i++){
        ...
        h_multi_bft[i] -> GetYaxis() -> SetTitleOffset(1.4);
        h_multi_bft[i] -> SetStats(0);
        h_multi_bft[i] -> Draw("COLZ");
        c -> Print(savepath.c_str());
        c -> Clear();
    }

    h_multi -> GetXaxis() -> SetLabelSize(0.05);
    h_multi -> GetYaxis() -> SetLabelSize(0.05);
    h_multi -> SetXTitle("Layer");
    h_multi -> SetYTitle("multiplicity");
    h_multi -> GetXaxis() -> SetTitleOffset(1.3);
    h_multi -> GetYaxis() -> SetTitleOffset(1.4);
    h_multi -> SetStats(0);
    h_multi -> Draw("COLZ");
    c -> Print(savepath.c_str());
    c -> Clear();
    ...
    h_x0y0_xy_cut -> GetYaxis() -> SetTitleOffset(1.4);
    h_x0y0_xy_cut -> SetStats(0);
    ...
    h_u0v0_xy_cut -> GetYaxis() -> SetTitleOffset(1.4);
    h_u0v0_xy_cut -> SetStats(0);
