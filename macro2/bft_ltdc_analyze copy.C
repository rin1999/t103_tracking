         ...
         for(int ifiber=0; ifiber<nfiber; ifiber++){
            ...
            for(int ihit=0; ihit<nhit; ihit++){
               ...
               for(int i=0; i<ltdc_utof_r->at(0).size(); i++){
                     if(utof_ltdc_min<ltdc_utof_r->at(0).at(i) && ltdc_utof_r->at(0).at(i)<utof_ltdc_max && utof_tot_min<tot_utof_l->at(0).at(0) && utof_tot_min<tot_utof_r->at(0).at(i)){
                        double ltdc_utof_mean = (ltdc_utof_l->at(0).at(0) + ltdc_utof_r->at(0).at(i))/2.0;
                        h_ltdc_bft[ilayer] -> Fill(ltdc_bft_val-ltdc_utof_mean);
                        h_tot_bft[ilayer]  -> Fill(tot_bft_val);
                        h_ltdc_tot_bft[ilayer] -> Fill(ltdc_bft_val-ltdc_utof_mean, tot_bft_val);
                        h_ltdc_tot_bft_correction[ilayer] -> Fill(ltdc_bft_val-ltdc_utof_mean - (parameter0[ilayer] + parameter1[ilayer]*tot_bft_val + parameter2[ilayer]*tot_bft_val*tot_bft_val), tot_bft_val);
                        h_ltdc_bft_correction[ilayer] -> Fill(ltdc_bft_val-ltdc_utof_mean - (parameter0[ilayer] + parameter1[ilayer]*tot_bft_val + parameter2[ilayer]*tot_bft_val*tot_bft_val));
                     }
                  }
               ...
               if(ltdc_min <= ltdc_bft_val && ltdc_bft_val <= ltdc_max){
                  for(int i=0; i<ltdc_utof_r->at(0).size(); i++){
                     if(utof_ltdc_min<ltdc_utof_r->at(0).at(i) && ltdc_utof_r->at(0).at(i)<utof_ltdc_max && utof_tot_min<tot_utof_l->at(0).at(0) && utof_tot_min<tot_utof_r->at(0).at(i)){
                        ...
                        e_counts++;
                        point_couter[ilayer]++;
                        h_ltdc_bft_ltdccut[ilayer] -> Fill(ltdc_bft_val-ltdc_utof_mean);
                        h_tot_bft_ltdccut[ilayer]  -> Fill(tot_bft_val);
                        h_ltdc_tot_bft_ltdccut[ilayer] -> Fill(ltdc_bft_val-ltdc_utof_mean, tot_bft_val);
                        h_ltdc_tot_bft_ltdccut_filp[ilayer] -> Fill(tot_bft_val, ltdc_bft_val-ltdc_utof_mean);
                        g_tot_ltdc_ltdccut[ilayer] -> SetPoint(point_couter[ilayer]-1, tot_bft_val, ltdc_bft_val-ltdc_utof_mean);
                        double y = ltdc_bft_val-ltdc_utof_mean - (parameter0[ilayer] + parameter1[ilayer]*tot_bft_val + parameter2[ilayer]*tot_bft_val*tot_bft_val);
...
// Printing
   ...
   */
   ...
   for(int ilayer=0; ilayer<nlayer; ilayer++){
      ...
      double p1 = fitfunc[ilayer] -> GetParameter(1);
      double p2 = fitfunc[ilayer] -> GetParameter(2);
      TPaveText* statBox = new TPaveText(0.6, 0.88, 0.85, 0.78, "NDC");
      statBox->SetFillColor(kWhite);
      statBox->SetLineColor(kBlack);
      statBox->SetTextAlign(12);
      statBox->AddText(Form("Fit results:"));
