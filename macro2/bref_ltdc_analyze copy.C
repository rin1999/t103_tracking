...
void bref_ltdc_analyze(const char* filename, const int max_entries){
   ...
   const double p_l[3] = {21.249, 4.517, -0.059};
   const double p_r[3] = {20.0, 5.750, -0.016};
...
// Fill histograms
   ...
   for(int ientry=0; ientry<nentries; ientry++){
      ...
      //for(int i=0; i<ltdc_utof_r->at(0).size(); )
      ...
      //if (flag_bref_l && flag_bref_r){
         ...
         //   for (int j=0; j<ltdc_bref_r->at(0).size(); j++){
         //      
         //   }   
         //}
         //cout << "ltdc_bref_l:" << ltdc_bref_l->at(0).size() << "   ltdc_bref_r:" << ltdc_bref_r->at(0).size() << endl;
         //cout << "##########################" << endl;
      //}
